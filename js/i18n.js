...
const translations = {
    en: {
        ...
        feat_fast_desc: 'Built with Electron architecture, currently optimized for macOS with excellent performance and responsiveness. Cross-platform support coming in future releases.',
        ...
        feat_mac_title: 'macOS Optimized',
        feat_mac_desc: 'Deep integration with macOS including LaunchDaemon helper for seamless system-level proxy management. Windows and Linux versions are on the roadmap.',
        ...
        step1_desc: 'Download the latest version from GitHub Releases for macOS (Apple Silicon or Intel). Windows & Linux coming soon.',
    ...
    zh: {
        ...
        feat_fast_desc: '基于 Electron 架构构建，目前针对 macOS 深度优化，提供出色的性能和响应速度。未来版本将支持跨平台。',
        ...
        feat_mac_title: 'macOS 深度优化',
        feat_mac_desc: '深度集成 macOS，包括 LaunchDaemon 助手，实现无缝的系统级代理管理。Windows 和 Linux 版本已在规划中。',
        screenshots_title: '应用截图',
        screenshots_subtitle: '一览 ClashFox 精美界面',
        install_title: '快速安装',
        install_subtitle: '几分钟内启动 ClashFox',
        step1_title: '下载',
        step1_desc: '从 GitHub Releases 下载 macOS 最新版本（Apple Silicon 或 Intel）。Windows 和 Linux 版本即将推出。',
